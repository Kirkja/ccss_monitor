 ...
 */
?>
<h3>Depth of Knowledge Guide</h3>
<div class="lessonArea">
    ...
    <ul>
        ...
        <li><b>DOK-4 (Extended):</b> Extended thinking – an investigation or application to real world, requires time to research, think, and process multiple conditions of the problem or task, non-routine manipulations across disciplines / content areas / multiple sources.</li>
    <ul>    
